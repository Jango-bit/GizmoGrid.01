            ...
            try
            {
                using (var stream = file.OpenReadStream())
                {
                    ...
                    if (uploadResult.Error != null)
                    {
                        ...
                        throw new CloudinaryUploadException($"Cloudinary error: {uploadResult.Error.Message}");
                    }

                    if (uploadResult.SecureUrl == null)
                    {
                        _logger.LogError("Cloudinary upload returned null SecureUrl.");
                        throw new CloudinaryUploadException("SecureUrl is null.");
                    }
