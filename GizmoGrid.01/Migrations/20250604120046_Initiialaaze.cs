...
{
    /// <inheritdoc />
    public partial class Initiialaaze : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FlowDiagrams", x => x.Id);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_FlowDiagrams_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Nodes_FlowDiagrams_FlowDiagramId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FlowDiagrams_ProjectId",
                table: "FlowDiagrams",
                column: "ProjectId");

            migrationBuilder.CreateIndex(
                name: "IX_FlowDiagrams_UserId",
                table: "FlowDiagrams",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_Nodes_FlowDiagramId",
                table: "Nodes",
